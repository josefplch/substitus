 ...
 * @version 2018-06-11
 */
public class ModifiedDiceB implements AssociationMetric {
    ...
    public boolean equals (Object object) {
        return (Objects.nonNull (object) && (object instanceof ModifiedDiceB));
    }
    
    @Override
    public String toString () {
        return "ModifiedDiceB";
    }
}
